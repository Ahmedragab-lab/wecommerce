{{-- @if (auth()->user()->hasPermission('update_users')) --}}
    <a href="{{ route('admin.users.edit', $id) }}" class="btn btn-warning btn-sm" title="@lang('site.edit')"><i class="fa fa-edit"></i> </a>
{{-- @endif --}}
    ...
    <div class="modal fade" id="bulkdelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.users.bulk_delete','ids') }}" method="POST">
                    <div class="modal-body">
                        @csrf
                        @method('DELETE')
